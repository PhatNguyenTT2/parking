...
Lợi ích: - Chuẩn hóa dữ liệu - Query chính xác hơn - Sử dụng index hiệu quả
...
Vai trò: - UID duy nhất của thẻ RFID - Key để tìm xe khi ra - Ngăn chặn 1 thẻ vào 2 lần
...
Process: 1. Find log by cardId (exitTime = null) 2. Validate license plate matches 3. Return vehicle data (không update DB)
Response (Success):
{
   "success": true,
   "data": {
